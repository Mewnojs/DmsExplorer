...
namespace DmsExplorer.Behaviors;
    ...
    private static void HandleCommandChanged(Interactive interactElem, AvaloniaPropertyChangedEventArgs args)
    {
        ...
        static void Handler(object? s, RoutedEventArgs e)
        {
            if (s is Interactive interactElem)
            {
                ...
                if (commandParameter is String && (string)(commandParameter) == "#EventArgs") { commandParameter = e; }
                else if (commandParameter is String && (string)(commandParameter) == "#Sender#EventArgs") { commandParameter = new object[] { s, e }; }
